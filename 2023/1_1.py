...
for code in encoded_strings:
    ...
    for index in range(len(code)):
        if code[index] in nums:
            secret_number += str(code[index])
            break
    for index in range(len(code)):
        if code[len(code) - index - 1] in nums:
            secret_number += str(code[len(code) - index - 1])
            break
    secret_numbers.append(int(secret_number))
